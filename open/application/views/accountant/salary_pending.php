        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-warning">
                    <h4 class="mb-0 text-white"><i class="fa fa-hourglass-half"></i> Pending Salaries</h4>
                </div>
                <div class="card-body">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <a href="<?php echo site_url('salary/approve/' . $salary->salary_payment_id); ?>" class="btn btn-sm btn-success" style="margin: 2px;">
                                                    <i class="fa fa-check"></i> Approve
                                                </a>
                                                <a href="<?php echo site_url('salary'); ?>" class="btn btn-sm btn-danger" style="margin: 2px;">
                    ...
                    <?php else: ?>
                        <div style="text-align: center; padding: 40px 20px; color: #999;">
                            <p style="font-size: 16px; margin: 0 0 10px 0;">No pending salaries</p>
                            <p style="font-size: 13px; margin: 0;"><a href="<?php echo site_url('salary'); ?>">Back to Salary Management</a></p>
                        </div>
                    <?php endif; ?>
