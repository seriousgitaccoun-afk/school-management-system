		...
		<div class="panel panel-info">
			...
			<div class="panel-body table-responsive">
				...
				<div class="form-group"> 
					 ...
					 <div class="col-sm-12">
  		  			 <input type='file' class="form-control" name="userfile" accept="image/jpeg,image/png,image/gif" onChange="readURL(this);">
				 <img id="blah" src="<?php echo $this->crud_model->get_image_url('teacher', $row['teacher_id']); ?>?t=<?php echo time(); ?>" alt="Teacher Profile Picture" height="200" width="200" style="margin-top: 10px; border: 1px solid #ddd; padding: 5px;"/>
