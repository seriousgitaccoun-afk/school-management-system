<?php 
$system_name = school_setting('system_title', 'School Management System');
$system_title = school_setting('system_title', 'School Management System');
?>
  ...
  <br><br><br>
    <div class="white-box">
	 <h4 class="box-title m-b-20" align="center">
					<img src="<?php echo get_school_logo(); ?>" class="img-circle" width="70" height="70"/></h4>
					<h5 align="center"><a href="<?php echo school_setting('website', '#'); ?>"><?php echo get_school_name(); ?></a></h5>
