...
<table id="example" class="table display">
                    ...
                    <?php 
                    $counter = 1; 
                    $students = (isset($class_id) && !empty($class_id)) ? 
                        $this->db->get_where('student', array('class_id' => $class_id))->result_array() : 
                        array();
                    ...
                    ?>
                        <tr>
                            <td colspan="10" style="text-align: center; padding: 20px; color: #999;">
                                ...
                                <?php echo (empty($class_id)) ? 'Please select a class to view students' : 'No students found in this class'; ?>
                            </td>
                        </tr>
                    <?php else:
