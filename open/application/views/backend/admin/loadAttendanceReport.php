...
<div class="row" align="center">
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table">
        ...
        <a href="<?php echo base_url();?>admin/printAttendanceReport/<?php echo $class_id ;?>/<?php echo $month ;?>/<?php echo $year ;?>" class="btn btn-success btn-sm btn-rounded btn-block" style="color:white"> <i class="fa fa-print"></i> Print</a>
