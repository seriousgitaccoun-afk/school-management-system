...
<script>
    // Global flag to disable client-side PDF exports (stubs will respect this)
    window._pdf_export_disabled = true;
    if (window.console) console.info('PDF export disabled globally (client-side)');
</script>
