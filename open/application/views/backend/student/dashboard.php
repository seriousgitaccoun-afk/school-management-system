 <!--row -->
            ...
            <div class="row m-b-20">
                    <div class="col-md-12">
                        <h4 style="margin-bottom: 15px; color: #2b2b2b;"><i class="fa fa-bolt"></i> Quick Links</h4>
                        <div class="row">
                            <div class="col-md-3 col-sm-6 col-xs-12 m-b-15">
                                <a href="<?php echo base_url();?>student/my_marks" class="btn btn-block btn-primary waves-effect" style="padding: 12px;">
                                    <i class="fa fa-list"></i><br/><small>View Marks</small>
                                </a>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12 m-b-15">
                                <a href="<?php echo base_url();?>student/my_attendance" class="btn btn-block btn-info waves-effect" style="padding: 12px;">
                                    <i class="fa fa-calendar-check-o"></i><br/><small>My Attendance</small>
                                </a>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12 m-b-15">
                                <a href="<?php echo base_url();?>student/assignment" class="btn btn-block btn-success waves-effect" style="padding: 12px;">
                                    <i class="fa fa-download"></i><br/><small>Assignments</small>
                                </a>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12 m-b-15">
                                <a href="<?php echo base_url();?>student/my_invoice" class="btn btn-block btn-warning waves-effect" style="padding: 12px;">
                                    <i class="fa fa-file-text-o"></i><br/><small>Fee Invoice</small>
                                </a>
                            </div>
                        </div>
                    </div>
