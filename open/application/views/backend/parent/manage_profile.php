		...
		<div class="panel panel-info">
			...
			<div class="panel-body table-responsive">
				...
				<div class="form-group"> 
				 ...
				 <img id="blah" src="<?php echo $this->crud_model->get_image_url('parent', $row['parent_id']); ?>?t=<?php echo time(); ?>" alt="Parent Profile Picture" height="200" width="200" style="margin-top: 10px; border: 1px solid #ddd; padding: 5px;"/>
