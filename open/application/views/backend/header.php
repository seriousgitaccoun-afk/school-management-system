 <!-- Navigation -->
        <link rel="stylesheet" href="<?php echo base_url('assets/css/navigation-sidebar.css'); ?>">
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                <div class="top-left-part"><a class="logo" href="#"><span class="hidden-xs"><strong><?php echo get_school_name(); ?></strong></span></a></div>
            ...
            <!-- <li class="dropdown"> 
                <a class="dropdown-toggle " data-toggle="dropdown" href="#"><i class="icon-note"></i>
                    ...
                    <li class="dropdown">
                        ...
                        ?>
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" style="display: flex; align-items: center; gap: 8px;">
                            <?php echo get_avatar_badge($name, 36); ?>
                            <b class="hidden-xs"><?php echo $name; ?></b>
                        </a>
